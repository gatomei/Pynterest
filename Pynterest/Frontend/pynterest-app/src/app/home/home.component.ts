...
export class HomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.photos.push({ title: 'Titlu', photo: [] });
    this.photos.push({ title: 'Titlu2', photo: [] });
    this.photos.push({ title: 'Titlu3', photo: [] });
    this.photos.push({ title: 'Titlu4', photo: [] });
    this.photos.push({ title: 'Titlu5', photo: [] });
    this.photos.push({ title: 'Titlu', photo: [] });
    this.photos.push({ title: 'Titlu2', photo: [] });
    this.photos.push({ title: 'Titlu3', photo: [] });
    this.photos.push({ title: 'Titlu4', photo: [] });
  ...
  loadInitPhotos() {
    this.photosService.getPhotosForFeed().subscribe((data) => (this.photos = data[0]));
  }

  getImageUrl(photo: Pin) {
    let image =
  ...
  loadNextPhotos() {
   ...
   // this.photosService.getPhotosForFeed();
   console.log("loading");
   this.spinner.hide();
  }
}
